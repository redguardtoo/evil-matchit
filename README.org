...
Pressing "3%" jumps to a line 3 percentage down the file. It's the default behaviour in original =evil-mode=. You can =(setq evilmi-may-jump-by-percentage nil)= to turn off this feature. Then "3%" will jump 3 times.
